...
const Instructors = ({ sections }: { sections: Section[] }) => {
    ...
    <div id="instructors">
      <div className="mb-7 xs:bg-[#EEF2F4] xs:pt-2 ">
        <div className="pt-4 pb-2 bg-white">
          ...
          {instructors.values.map(({ name, slug, image, description }) => (
            <div
              key={slug}
              className="flex items-center md:rounded-md md:border md:p-5 mb-4"
            >
              <div>
                <div
